...
List<CategorieModel> getCategories(){
  ...
  categorieModel.categorieName = "İş Dünyası";
  ...
  //2
  categorieModel = new CategorieModel();
  categorieModel.categorieName = "Eğlence";
  ...
  //3
  categorieModel = new CategorieModel();
  categorieModel.categorieName = "Genel";
  ...
  //4
  categorieModel = new CategorieModel();
  categorieModel.categorieName = "Sağlık";
  ...
  //5
  categorieModel = new CategorieModel();
  categorieModel.categorieName = "Bilim";
  ...
  //5
  categorieModel = new CategorieModel();
  categorieModel.categorieName = "Spor";
  ...
  //5
  categorieModel = new CategorieModel();
  categorieModel.categorieName = "Teknoloji";
